...
mod tests {
    ...
    fn test_loop() {
        // Test while loop
        assert_parse(Parser::FuncDecParser, "int func(int a, int b) { while(a > b) { a = a - 1; }}", "Function: func:[Body: [While Loop (Condition: a > b): \n do Body: [Assignment: a = (a - 1: i32)]]]");
        // Test for loop
        assert_parse(Parser::FuncDecParser, "int func(int a, int b) { for(int i = 0; i < 10; i = i + 1) { a = a + 1; }}", 
            "Function: func:[Body: [For Loop ([Initial] Assignment: Variable Declaration: i = [0: i32] with dimensions [] = 0: i32; [Condition] Condition: i < 10: i32; [Increment] Assignment: i = (i + 1: i32)): \n do Body: [Assignment: a = (a + 1: i32)]]]");
    ...
    fn test_assignexpr() {
        ...
        "Function: func:[Body: [Assignment: Variable Declaration: a = [0: i32] with dimensions [] = 2: i32, Assignment: Variable Declaration: b = [0: i32] with dimensions [] = a, Assignment: b = 3: i32, Assignment: b = (b + 1: i32), Assignment: a = (a - 1: i32), Return: (b + a)]]");
    }
    ...
    fn test_func_call() {
        ...
        "Function: func:[Body: [Assignment: Variable Declaration: k = [0: i32] with dimensions [] = FuncCall: add[FuncCall: add[a, b], b], Return: k]]");
    }

    #[test]
    fn test_stmt(){
        assert_parse(Parser::StmtParser, "int a;", "Global Variable: Variable Declaration: a = [0: i32] with dimensions []");
        assert_parse(Parser::StmtParser, "struct obj { int a; char b; };", "Struct obj: [Variable Declaration: a = [0: i32] with dimensions [], Variable Declaration: b = [ : char] with dimensions []]");
    ...
    fn test_1_r01() {
        ...
        "Function: test_1_r01:[Body: [Assignment: c = c: char, If: Condition: a > b then Body: [Return: a] else Body: [Return: b]]]");
    }

    // #[test]
    // fn test_1_r02() {
    //     assert_parse_from_file(Parser::ProgramParser, "../test/test_1_r02.spl", 
    //     "Function: test_1_r02:[Body: [Assignment: c = c: char, If: Condition: a > b then Body: [Return: a] else Body: [Return: b]]]");
    // }
}
